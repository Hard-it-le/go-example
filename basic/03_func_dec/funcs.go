...
// Fun1 多个参数，多个返回值。参数有名字，但是返回值没有 推荐写法二
func Fun1(a string, b int) (int, string) {
	println("函数有多个参数，多个返回值。参数有名字，但是返回值没有 ")
	println("=====================")
	return 0, "你好"
}
...
func Fun2(a string, b string) (age int, name string) {
	println("函数有多个参数，多个返回值。参数有名字，返回值也有名字 ")
	println("=====================")
	age = 19
	name = "Tom"
	return
...
func Fun3(a, b, c string, abc, bcd int, p string) (d, e int, g string) {
	println("函数有多个参数具有相同类型放在一起，可以只写一次类型 ")
	println("=====================")
	d = 15
	e = 16
	g = "你好"
